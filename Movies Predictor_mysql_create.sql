...
ALTER TABLE `movies_people_roles` ADD CONSTRAINT `movies_people_roles_fk0` FOREIGN KEY (`movies_id`) REFERENCES `movies`(`id`);
...
ALTER TABLE `movies_origin_countries` ADD CONSTRAINT `movies_origin_countries_fk0` FOREIGN KEY (`movies_id`) REFERENCES `movies`(`id`);
